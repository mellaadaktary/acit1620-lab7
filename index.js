...
'https://i.ibb.co/ccNyKX0/fruit-uzxc.jpg' ];
 ...
 const image = document.getElementsByClassName('card');

    for (let i = 0; i < randomUrls.length; i++){
        image[i].getElementsByTagName('img')[0].src = randomUrls[i];
    }

    const exclamtion = document.getElementsByTagName('h1')[0];
    exclamtion.textContent += '!';
